...
export default function RiderMap({
  ...
  // Listen to assigned driver location updates (for both matched, arrived, and on_trip status)
  useEffect(() => {
    if (
      !assignedDriverId ||
  ...
  useEffect(() => {
    ...
    // CASE 2: MATCHED or ARRIVED (Driver coming to pickup or at pickup)
    else if (
      (rideStatus === "matched" || rideStatus === "arrived") &&
      assignedDriverLocation &&
      pickup
            ...
            <div style={styles.mapCard}>
              ...
              >
                ...
                >
                  ...
                  {/* Assigned Driver Marker (when matched or arrived) */}
                  {(rideStatus === "matched" || rideStatus === "arrived") &&
                    assignedDriverLocation && (
                      <Marker
