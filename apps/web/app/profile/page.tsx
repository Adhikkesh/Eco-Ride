...
import { FaCamera, FaChevronLeft, FaEnvelope, FaPhone, FaSpinner, FaUser } from "react-icons/fa";
...
export default function ProfilePage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setInitialData({ displayName, phoneNumber });
      setIsEditing(false);
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              ...
              <span style={{ color: "#64748b", fontSize: "12px" }}>Email cannot be changed</span>
            </div>
          </div>
