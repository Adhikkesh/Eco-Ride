  ...
  var tt = (t, e, n, r) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (const i of Ze(e))
        !Ye.call(t, i) &&
          i !== n &&
          he(t, i, { enumerable: !(r = Ge(e, i)) || r.enumerable, get: () => e[i] });
    return t;
  };
  var nt = (t, e, n) => (
    (n = t != null ? Ke(Xe(t)) : {}),
    tt(e || !t || !t.__esModule ? he(n, "default", { enumerable: !0, value: t }) : n, t)
  );
  var ye = et((me, ge) => {
    (function () {
      var t = (e) => {
...
`,
      ...
      (t.stemmer = (() => {
        var e = {
          ...
          n = { alize: "al", ative: "", ful: "", ical: "ic", icate: "ic", iciti: "ic", ness: "" },
          r = "[^aeiou]",
          i = "[aeiouy]",
          s = r + "[^aeiouy]*",
          o = i + "[aeiou]*",
      ...
      (t.TokenSet = function () {
        ...
        (t.TokenSet.fromFuzzyString = (e, n) => {
          for (var r = new t.TokenSet(), i = [{ editsRemaining: n, node: r, str: e }]; i.length; ) {
            var s = i.pop();
            if (s.str.length > 0) {
              ...
              o in s.node.edges
                ...
                i.push({ editsRemaining: s.editsRemaining, node: a, str: s.str.slice(1) });
            }
            if (s.editsRemaining != 0) {
              ...
              if (
                ...
                i.push({ editsRemaining: s.editsRemaining - 1, node: c, str: s.str }),
                s.str.length > 1 &&
                  i.push({
                ...
                s.str.length == 1 && (l.final = !0),
                  i.push({ editsRemaining: s.editsRemaining - 1, node: l, str: s.str.slice(1) });
              }
              if (s.str.length > 1) {
        ...
        (t.TokenSet.prototype.toArray = function () {
          for (var e = [], n = [{ node: this, prefix: "" }]; n.length; ) {
            var r = n.pop(),
            ...
            for (var o = 0; o < s; o++) {
              var a = i[o];
              n.push({ node: r.node.edges[a], prefix: r.prefix.concat(a) });
            }
          }
          return e;
        }),
        ...
        (t.TokenSet.prototype.intersect = function (e) {
          for (
            var n = new t.TokenSet(), r = void 0, i = [{ node: this, output: n, qNode: e }];
            i.length;
          ) {
            r = i.pop();
            for (
              ...
              for (var d = s[l], f = 0; f < c; f++) {
                ...
                if (p == d || d == "*") {
                  ...
                  p in r.output.edges
                    ...
                    i.push({ node: v, output: m, qNode: x });
                }
              }
          }
          return n;
        ...
        (t.TokenSet.Builder.prototype.insert = function (e) {
          ...
          for (var i = r; i < e.length; i++) {
            var s = new t.TokenSet(),
              o = e[i];
            (n.edges[o] = s), this.uncheckedNodes.push({ char: o, child: s, parent: n }), (n = s);
          }
          ...
          for (var c = 0; c < u.length; c++) {
            ...
            if (V.contains(h) && !A.contains(h)) {
              ...
              if ((H = P[h]) !== void 0) (H.score += Q), H.matchData.combine(r[k]);
                ...
                var b = { matchData: r[k], ref: h, score: Q };
                (P[h] = b), y.push(b);
              }
            }
          }
      ...
      (t.Builder = function () {
        ...
        (t.Query.presence = { OPTIONAL: 1, PROHIBITED: 3, REQUIRED: 2 }),
  ...
  var pe = [];
  function X(t, e) {
    pe.push({ constructor: t, selector: e });
  }
  var Z = class {
      ...
      pe.forEach((n) => {
        e.querySelectorAll(n.selector).forEach((r) => {
          r.dataset.hasInstance ||
            (new n.constructor({ app: this, el: r }), (r.dataset.hasInstance = String(!0)));
        });
      });
    }
    filterChanged() {
...
`),
  ...
  function _e() {
    ...
    o.base.endsWith("/") || (o.base += "/"),
      ...
      Se(o, s),
      ot({ field: n, results: r, searchEl: e, status: s, trigger: t }, o);
  }
  function ot(t, e) {
